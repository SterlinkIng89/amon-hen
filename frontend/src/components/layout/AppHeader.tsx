...
export default function AppHeader({
  ...
  const [tickerContent, setTickerContent] = useState<string | number>(
    queueCount,
  );
      ...
      <div className="flex items-center gap-6 shrink-0 h-full border-r border-border-subtle pr-4">
        ...
        {ytAuthed && (
          ...
          >
            <svg
              ...
              viewBox="0 0 24 24"
              fill="currentColor"
              className={view === "channel" ? "text-accent" : ""}
            >
        ...
        {ytAuthed && (
          ...
          >
            <svg
              ...
              viewBox="0 0 24 24"
              fill="currentColor"
              className={view === "stats" ? "text-accent" : ""}
            >
        ...
        >
          <svg
            ...
            viewBox="0 0 24 24"
            fill="currentColor"
            className={view === "steam" ? "text-accent" : ""}
          >
            ...
            >
              ...
              <div className="relative z-10 flex items-center gap-2 shrink-0">
                <svg
                  ...
                  viewBox="0 0 24 24"
                  fill="currentColor"
                  className={isQueueView ? "text-accent" : ""}
                >
              ...
              <div
                ...
                style={{
                  width:
                    queueCount > 0 || tickerPhase !== null ? "34px" : "0px", // 26px badge + 8px margin
                  opacity: queueCount > 0 || tickerPhase !== null ? 1 : 0,
                  overflow: "hidden",
                  transition:
                    "width 0.3s cubic-bezier(0.22, 1, 0.36, 1), opacity 0.3s ease",
                  display: "flex",
 ...
 `}
                >
                  <span
                    ...
                    style={{
                      ...
                      lineHeight: 1,
                      color:
                        typeof tickerContent === "string" &&
                        tickerContent.startsWith("+")
                          ? hasUploading
                            ? "#a7f3d0"
                            : "#10b981"
                          : typeof tickerContent === "string" &&
                      ...
                      animation:
                        tickerPhase === "out"
                          ? "badgeNumOut 0.16s ease forwards"
                          : tickerPhase === "in"
                            ? "badgeNumIn 0.16s ease forwards"
                            : tickerPhase === "out-down"
                              ? "badgeNumOutDown 0.16s ease forwards"
                              : tickerPhase === "in-down"
                                ? "badgeNumInDown 0.16s ease forwards"
                                : "none",
                    }}
                  >
      ...
      <div className="flex items-center gap-[7px] flex-1 justify-end min-w-0">
        ...
        <button className="btn btn-ghost relative" onClick={onOpenSettings}>
          ...
          {ytAuthed && (
            <span
              className="absolute top-[5px] right-[5px] w-1.5 h-1.5 bg-green-400 rounded-full "
