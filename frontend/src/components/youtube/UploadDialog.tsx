        ...
        <div className="flex-1 overflow-y-auto max-h-[70vh] custom-scrollbar">
          <div className="p-5 pb-40 flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-1.5 relative">
              ...
              {hasUnfilledPlaceholders(
                video,
                video.game ? profiles[video.game] : undefined,
              ) && (
                <div className="flex items-center gap-1.5 px-2.5 py-1.5 rounded-sm bg-amber-500/10 border border-amber-500/30 text-amber-300 text-xs mt-1">
                  ...
                  <span>
                    This title contains unfilled placeholder variables from its
                    game profile.
                  </span>
                </div>
              )}
            ...
            <div className="flex flex-col gap-1.5 relative">
              ...
              <textarea
                className="w-full bg-elevated border border-border-subtle rounded-sm px-3 py-2 text-sm text-text-primary outline-none transition-colors hover:border-border-medium focus:border-accent focus:bg-card focus: resize-y min-h-[80px]"
                value={description}
              ...
              {isCreating ? (
                <div className="flex flex-col gap-1.5">
                  ...
                  <span className="text-[10px] text-text-muted">
                    If a playlist with this name already exists on your channel,
                    it will be reused.
                  </span>
                  {playlistError && (
            ...
            <div className="mx-4 mb-3 flex items-start gap-2.5 p-3 bg-yellow-500/10 border border-yellow-500/30 rounded-sm animate-fadeIn">
              ...
              <div className="flex flex-col gap-0.5">
                ...
                <span className="text-[11px] text-yellow-400/70">
                  ...
                  . Remove it from the queue first to avoid duplicates.
                </span>
              </div>
            </div>
          )}
