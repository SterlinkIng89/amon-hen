...
export default function YouTubeInlinePlayer({
  ...
  return (
    <div
      className={`flex-1 flex overflow-hidden bg-[#0f0f0f] ${isWide ? "flex-row" : "flex-col"}`}
    >
      {/* Player Area */}
      ...
      {/* Info Panel */}
      <div
        className={`bg-[#0f0f0f] border-white/10 overflow-y-auto custom-scrollbar shrink-0 text-white ${isWide ? "border-l w-[420px] h-full p-6" : "border-t max-h-[280px] p-4"}`}
      >
        <div
          className={`max-w-4xl mx-auto flex flex-col ${isWide ? "gap-6" : "gap-3"}`}
        >
          ...
          <div
            className={`flex flex-wrap items-center gap-4 text-sm text-white/60 border-b border-white/10 ${isWide ? "pb-5" : "pb-3"}`}
          >
            ...
            {isEditing ? (
              ...
              >
                {editablePrivacy.charAt(0).toUpperCase() +
                  editablePrivacy.slice(1)}
              </span>
            )}
                            ...
                            .map((p) => (
                              ...
                              >
                                ...
                                <svg
                                  ...
                                  viewBox="0 0 24 24"
                                  fill="currentColor"
                                  className="text-[#3ea6ff] opacity-0 group-hover:opacity-100 transition-opacity ml-2"
                                >
