...
export default function DuplicateWarningDialog({
 ...
 {isSingle 
 ? <>This video is already in your <span className="text-text-primary font-semibold">'{playlistName}'</span> playlist.</>
 : <><span className="text-accent font-bold text-lg">{duplicateCount}</span> of the selected videos are already in your <span className="text-text-primary font-semibold">'{playlistName}'</span> playlist.</>
 }
 </p>
