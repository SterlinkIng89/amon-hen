...
export default function FieldInput({
  ...
  const { getRecentValues, addRecentValue, removeRecentValue } =
  ...
  return (
    <div className="relative flex-1" ref={containerRef}>
      <input
        ...
        className={
          className ||
          "w-full bg-elevated border border-border-subtle rounded-sm px-3 py-2 text-sm text-text-primary outline-none transition-colors hover:border-border-medium focus:border-accent focus:bg-card"
        }
